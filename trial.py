...
class AudioDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # mixture_mel = T.MelSpectrogram(sample_rate=SAMPLE_RATE, normalized=True, n_mels=64)(mixture)
        source_mels = []
        for source_path in data_path[1:]:
            source, _ = torchaudio.load(source_path)
            # source_mel = T.MelSpectrogram(sample_rate=SAMPLE_RATE, normalized=True, n_mels=64)(source)
